 ...
 * @author Asus
 */
public class ListUniversite extends BaseForm{
    Form current;

    public ListUniversite(Resources res){
        
        super("Liste Universite",BoxLayout.y());
        
        Toolbar tb = new Toolbar(true);
        current = this;
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Liste des Universite");
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Universitées", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Universite", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Universitées", barGroup);
        ...
        ArrayList<Universite>list = Service_universite.getInstance().findAll();
        
        for(Universite art:list){
    ...
    private void addButton(Image img, Universite art,Resources res) {
        ...
        Label titreTxt = new Label("Nom : "+art.getNom(),"NewsTopLine2");
            ...
            Label titreTxt2 = new Label("Adresse : "+art.getAdresse(),"NewsTopLine2");
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
         new ModifierUniversiteForm(res, art).show();
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(lModifier,lQrCode)
