...
public class ListEvent extends BaseForm{
    ...
    public ListEvent(Resources res){
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Events", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Evenement", barGroup);
        ...
        ArrayList<Event>list = Service_Event.getInstance().findAll();
    ...
    private void addButton(Image img, Event art,Resources res) {
        ...
        Label titreTxt = new Label("Description : "+art.getDescription(),"NewsTopLine2");
            ...
            Label titreTxt2 = new Label("Date : "+art.getDate(),"NewsTopLine2");

                  Label titreTxt3 = new Label("Heure : "+art.getHeure(),"NewsTopLine2");
                  Label titreTxt4 = new Label("Lien : "+art.getLien(),"NewsTopLine2");
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
         new ModifierEventForm(res, art).show();
