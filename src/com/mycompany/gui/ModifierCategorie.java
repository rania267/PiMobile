...
public class ModifierCategorie extends BaseForm{
    ...
    public ModifierCategorie(Resources res, Categorie rec) {
...
tb.addSearchCommand(e -> {
       ...
       // TextField LPD = new TextField(rec.getPrixlpd(), "LPD", 20, TextField.ANY);
        ...
        TextField Doamine = new TextField(String.valueOf(rec.getDomaine()), "Domaine", 20, TextField.ANY);
        TextField cat = new TextField(String.valueOf(rec.getNomcat()), "Nom Categorie", 20, TextField.ANY);

        
 
        Doamine.setUIID("NewsTopLine");
        Doamine.setSingleLineTextArea(true);
        ...
        btnModifier.addPointerPressedListener(l -> {
          rec.setDomaine(Doamine.getText());
           rec.setNomcat(cat.getText());


            if (Service_Categorie.getInstance().ModifierCategorie(rec)) {
