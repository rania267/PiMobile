...
tb.addSearchCommand(e -> {
        ...
        TextField Date = new TextField(String.valueOf(rec.getDate()), "Date", 20, TextField.ANY);
        TextField Heure = new TextField(String.valueOf(rec.getHeure()), "Heure", 20, TextField.ANY);
        TextField Lien = new TextField(String.valueOf(rec.getLien()), "Lien", 20, TextField.ANY);
        ...
        Heure.setUIID("NewsTopLine");
        Heure.setSingleLineTextArea(true);
        
        Lien.setUIID("NewsTopLine");
        Lien.setSingleLineTextArea(true);
        ...
        btnModifier.addPointerPressedListener(l -> {
          ...
          rec.setHeure(Heure.getText());
           rec.setLien(Lien.getText());


            if (Service_Event.getInstance().EditEvent(rec)) {
        ...
        swipe.addTab("", res.getImage("back-logoo.jpeg"), page1);
    }
