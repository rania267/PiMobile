 ...
 * @author Asus
 */
public class ListeCategorie extends BaseForm{
     Form current;

    public ListeCategorie(Resources res){
        
        super("ListeCategorie",BoxLayout.y());
        ...
        RadioButton partage = RadioButton.createToggle("Categories", barGroup);
...
Button Share=new Button("Share");
 ...
 liste.addPointerPressedListener(l->{
     Display.getInstance().execute("https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=http%3A%2F%2F127.0.0.1%3A8000%2Fequipe_mobile&display=popup&ref=plugin&src=share_button");
        ...
        ArrayList<Categorie>list = Service_Categorie.getInstance().findAll();
        
        for(Categorie art:list){
    ...
    private void addButton(Image img, Categorie art,Resources res) {
        ...
        Label titreTxt = new Label("Nom Categorie: "+art.getNomcat(),"NewsTopLine2");
        
            Label titreTxt2 = new Label("Domaine : "+art.getDomaine(),"NewsTopLine2");
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
        new ModifierCategorie(res, art).show();
