 ...
 * @author Asus
 */
public class ListeCours extends BaseForm{
    
    
     Form current;

    public ListeCours(Resources res){
        
        super("ListeCours",BoxLayout.y());
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Cours", barGroup);
...
Button Share=new Button("Share");
 ...
 liste.addPointerPressedListener(l->{
     Display.getInstance().execute("https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=http%3A%2F%2F127.0.0.1%3A8000%2Fequipe_mobile&display=popup&ref=plugin&src=share_button");
        ...
        ArrayList<Cours>list = Service_Cours.getInstance().findAll();
    ...
    private void addButton(Image img, Cours art,Resources res) {
        ...
        Label titreTxt = new Label("Titre : "+art.getTitre(),"NewsTopLine2");
            ...
            Label titreTxt2 = new Label("Duree : "+art.getDuree(),"NewsTopLine2");
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
          new ModifierCoursForm(res, art).show();
