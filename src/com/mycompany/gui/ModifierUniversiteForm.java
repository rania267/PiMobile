 ...
 * @author Asus
 */
public class ModifierUniversiteForm extends BaseForm{
     Form current;

    public ModifierUniversiteForm(Resources res, Universite rec) {
       super("Newsfeed", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        current = this;
        setToolbar(tb);
        getTitleArea().setUIID("container");
        setTitle("Modifier Universite");
...
tb.addSearchCommand(e -> {
        ...
        TextField mdpuni = new TextField(rec.getMdpuni(), "mdpuni", 20, TextField.ANY);
      
        TextField Adresse = new TextField(String.valueOf(rec.getAdresse()), "Adresse", 20, TextField.ANY);
        ...
        mdpuni.setUIID("NewsTopLine");
        mdpuni.setSingleLineTextArea(true);
        ...
        btnModifier.addPointerPressedListener(l -> {
          rec.setAdresse(Adresse.getText());
          rec.setEmail(Email.getText());
          rec.setMdpuni(mdpuni.getText());
           rec.setNom(Nom.getText());


            if (Service_universite.getInstance().EditUniversite(rec)) {
